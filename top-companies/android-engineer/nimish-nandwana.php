                    ...
                    <main class="col-lg-8">
                        <article class="ps-lg-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 mb-1"> <a href="https://www.feufo.com/pdf_download.php?file_id=<?= $ress['id'];?>" class="btn btn-warning mb-10"> <i class="me-1 fa fa-download"></i> View / Download Resume </a></div>
