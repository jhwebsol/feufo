...
if(isset($_SESSION['loggedin_employer']) && $_SESSION['loggedin_employer'] == true){
 ...
 echo "<script>location.replace('https://www.feufo.com/login.php'); </script>";
...
<?php //$id=$_POST["id"];
 $sql_prdd="select sub_category.sub_category_name,category.cat_name,employee_details.* from employee_details join category on employee_details.cat_id=category.id join sub_category on employee_details.subcat_id=sub_category.id";
                ...
                <form method="post" action="">
                 <div class="row filters-outer">
                                ...
                                <div class="col-md-12 filter-block">
                                    <h4>Category</h4>
                                    <div class="form-group">
                                        <select class="chosen-select" name="idd">
                    ...
                    <div class="content-column col-lg-9 col-md-9 col-sm-12">
                        <div class="ls-outer">
                            <div class="row">
                                ...
                                $emp_id=$res1['emp_id'];
                                $sql_prdd="select sub_category.sub_category_name,category.cat_name,employee_details.* from employee_details join category on employee_details.cat_id=category.id join sub_category on employee_details.subcat_id=sub_category.id where employee_details.cat_id='$idd' and employee_details.id='".$emp_id."' and  employee_details.location like '%".$location."%' and (employee_details.experience_level between '".$exp1."' and '".$exp2."') and employee_details.salary='".$salarys."' and employee_details.dg_id='".$timezones."'"; } } }else{
                                $sql_prdd="select sub_category.sub_category_name,category.cat_name,employee_details.* from employee_details join category on employee_details.cat_id=category.id join sub_category on employee_details.subcat_id=sub_category.id"; }
                                 $result_prdd = mysqli_query($conn, $sql_prdd);
