                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-3" >
                            ...
                            <?php $idd=$_GET['id']; $empr_id=$_SESSION['employer_id'];
                            $sqlts =mysqli_query($conn,"SELECT * FROM candidate_interview_details WHERE emp_id = '".$idd."' and '".$empr_id."' ");
                             ...
                             <div class="row">
                              ...
                              <div class="table-responsive " id="dynamic_field"> 
                                <div class="" style="width:20%;float:left;">
                                    ...
                                    <input value="<?= $ress['id']; ?>" type="hidden" name="cdi_id" id="cdi_id" style="width:100%">
                                </div>
        ...
        $('body').on('click', '.laststep', function() {
           ...
           // alert(video_link);
            $.ajax({
                ...
                success: function(data) {
                      alert(data);
                      window.location.href = 'https://www.feufo.com/';
                }
            });
        });
    }); 
...
$(function() {
 $('body').on('click', '.nexttme', function() {
   ...
   var cdid = $container.find("#cdi_id").val();      
