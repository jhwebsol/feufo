...
move_uploaded_file($tmp_file,"emp/".$wkimg);
    if(file_exists('../'.$category.'/'.$sub_category)){
        if(!file_exists('../'.$category.'/'.$sub_category.'/'.$emp_name)){
            ...
            $sql="INSERT into employee_details(home_page,cat_id,subcat_id,emp_name,email_id,password,mobile_no,salary,feufo_fees,location,dg_id,job_type,avalibility,experience_level,assetment_link,resume,github,linkedin,twitter,discord,image,image2,image3,image4,image5,previous_company,previous_comp_linkedin,present_company,present_comp_linkedin,job_title,title,meta_keyword,desp,created_date) values ('$home_page','$category_id','$sub_category_id','$emps_name','$email_id','$passwordhash','$mobile_no','$salary','$feufo_fees','$location','$timezones','$job_type','$avalibility','$experience_level','$assetment_link','$resume','$github','$linkedin','$twitter','$discord','$image','$image2','$image3','$image4','$image5','$wimg','$previous_comp_linkedin','$wkimg','$present_comp_linkedin','$job_title','$title','$meta_keyword','$desp','$datetime')";
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon">
                                                    ...
                                                    <select name="category_id" id="cat_id" class="form-control" required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="sub_category_id" id="sub_cat" class="form-control" required>
                                                <option>Select</option>
                                                </select>
                                            </div>
                                        </div>
							...
							<div class="clearfix"></div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="feufo_fees" class="form-control" placeholder="Enter Feufo Fees ">
                                            </div>
                                        </div>
                                        <div class="col-md-8">
