						...
						<div class="box box-danger">
							...
							<div class="box-body table-responsive">
								<table class="table table-bordered example1">
									...
									<tbody> 
										<?php $j=1;
							            $sqlrw=mysqli_query($conn,"select dproperty_enquiry.*,es_property.property_name from dproperty_enquiry join es_property on dproperty_enquiry.property_id=es_property.id order by id DESC ");
		                           ...
		                           <tr class="odd">
		                            <td class="sorting_1"><?php echo $j; $j++; ?></td>
									 ...
									 <td>
		                                Service= <?php echo $res['rating']; ?> <i class="fa fa-star" aria-hidden="true"></i>
		                               </td>
	...
	<script>
		  ...
		  function delete_enq_by_ID(id)
		{
			if (confirm('Do You Want to Deleting This \nContinue anyway?')) {
				window.location.href = 'delete_penquiry.php?id=' + id;
			}
		}
...
$('.nstatus').on('change', function(){
    ...
    var dbdetails="dproperty_enquiry";
    if(nstatus){
        $.ajax({
            type:'POST',
