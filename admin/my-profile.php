...
$sql1 ="UPDATE  es_admin_user SET username='$username',name='$name',contact_no='$contact_no',about_us='$about_us',address='$address',facebook='$facebook',twitter='$twitter',linkdin='$linkedin',whatsapp='$whatsapp',website='$website',password='$password' WHERE id='$id'"; 
...
$path = "img/".$resg->id.'bn'.'.'.$extension;
$upath = "img/".$resg->banner;
unlink($upath);
 move_uploaded_file($tn,$path);
 $banner = $resg->id.'bn'.'.'.$banner;
} else {
  $banner = $resg->banner;
} 
...
$path = "img/".$resg->id.'im'.'.'.$extension;
$upath = "img/".$resg->image;
unlink($upath);
 move_uploaded_file($tn,$path);
 $bimage = $resg->id.'im'.'.'.$image;
} else {
  $bimage = $resg->image;
} 
                            ...
                            <form method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Email </label>
                                        <input type="email" name="username" value="<?= $res['username']; ?>" class="form-control" placeholder="Email">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
