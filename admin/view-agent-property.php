					...
					<div class="col-xs-12">
						<div class="box box-danger">
							<div class="box-header">
								<div class="row">
									<div class="col-md-4">
										<h3 class="box-title">View Agent Property Details</h3>
									</div>
									<div class="col-md-1 pull-right"><a href="agent_properties.php"><button class="btn btn-flat btn-custom2 btn-block"><i class="fa fa-arrow-left"></i> Back</button></a> </div>
								</div>
							</div>
							<div class="box-body">
											 ...
											 $sqllc=mysqli_fetch_array(mysqli_query($conn,"select * from nearest_location where id=".$uid)); ?>
												...
												<tr class="even">
													...
													<td colspan="3"><?php $id=$res['id'];
													 $sqlss=mysqli_query($conn,"select aminities.* from property_aminities join aminities on property_aminities.aminity=aminities.id where property_aminities.property_id=".$id);
												...
												<tr class="even">	
													<th>Status : </th>
													<td><?php if($res['status']=='1'){ echo "Yes"; }else{ echo "No"; }; ?></td> 	
													<th>Featured : </th>
													<td><?php if($res['featured']=='1'){ echo "Yes"; }else{ echo "No"; }; ?></td> 
												</tr>
												<tr class="odd">	
													<th>Top Property: </th>
													<td><?php if($res['top_property']=='1'){ echo "Yes"; }else{ echo "No"; }; ?></td> 	
													<th>Urgent Property: </th>
													<td><?php if($res['urgent_property']=='1'){ echo "Yes"; }else{ echo "No"; }; ?> </td> 
												</tr> 
												<tr class="even">	
													<th>Seo Title: </th>
