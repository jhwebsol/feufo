					...
					<div class="col-md-12">
						<div class="box box-danger">
							<div class="box-header with-border">
								<h3 class="box-title">Property Enquiry </h3>
							</div>
							<!-- /.box-header -->
							<div class="box-body table-responsive">
								<table class="table table-bordered example1">
									...
									<tbody>
										<?php $j=1;
							            $sql2="SELECT a.*,p.property_name,us.name,us.email_id from user_interest_prpty a join es_property p on a.property_id=p.id join user_profile us on a.user_id=us.id where a.property_id=".$_GET['id']; 							            $exe2=mysqli_query($conn,$sql2);
