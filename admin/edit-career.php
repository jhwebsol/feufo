...
$sql1 ="UPDATE career_detail SET job_title='$job_title',desp='$desps' WHERE id='$id'"; 
$res=mysqli_query($conn,$sql1) or die(mysqli_error());
if($res){
$sqlg = "SELECT * from career_detail where id = '$id'";
...
$resg = mysqli_fetch_object($resultg);
	...
	$path = "img/document/".$resg->id.'.'.$extension;
	$upath = "img/document/".$resg->image;
	unlink($upath);
    ...
    $sqlup = "UPDATE career_detail SET image='$image_ban'
			 WHERE  id = $resg->id";
				...
				<div class="row">
					...
					<div class="col-xs-12">
						<div class="box box-danger">
							...
							<?php $id=$_GET['id'];
							$sql2="SELECT * from career_detail where id='$id'";
										...
										<div>
											<div class="row">	
												<div class="col-md-12">
													<div class="form-group">
														...
														<input class="form-control" placeholder="Enter Job Title" name="job_title" type="text" value="<?php echo $res['job_title']; ?>">
													</div>
												</div> 
											</div>
											...
											<div class="row">
												<div class="col-md-12">
													...
													<textarea class="form-control" id="summernote"  placeholder="Enter Description" name="desp"><?php echo $res['desp']; ?></textarea>
													</div>
												</div>	
											</div>
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group">
														...
														<img src="img/document/<?php echo $res['image']; ?>" width="60px">
													</div>
												</div>	
											</div>
