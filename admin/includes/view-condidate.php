...
{ extract($_POST);
$id=$_GET["id"];
$sql_prd="INSERT into skills(prod_id,total_no_prod_quantity,prod_quantity,prod_quantity_type,prod_discount,prod_price,prod_cross_price) values ('$id','$total_no_prod_qua','$prod_quantity','$prod_quantity_type','$prod_discount','$prod_price','$prod_cross_price')";
					...
					<div class="col-xs-12">
						<div class="box box-danger">
                          ...
                          <tr>
													...
													<th>Image:</th>
													<td><img src="emp/skill/<?php echo $resr1['image']; ?>" style="width:30px;"></td> 
												</tr>
												<tr>
