                    ...
                    <div class="col-md-4">
                      ...
                      <div class="input-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="address">Feufo fees <span class="text-danger">*</span></label>
                                    <input type="text" name="feufo_fees" value="<?php echo $res['feufo_fees']; ?>" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
