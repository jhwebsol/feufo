                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3">
                        <ul class="navgation">
                            ...
                            <a href="employer-all-candidate.php" class="boxactive"><i class="la la-bookmark-o"></i>All Candidates</a>
                              ...
                              <div class="ls-widget">
                                <div class="tabs-box">     
                                    <div class="widget-content">
                                        <div class="row">
                                             <div class="col-lg-12 col-md-12 mb-4"> <h3 class="text-black">All Candidates</h3></div>                                        
