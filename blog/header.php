	...
	<div class="main-box">
		  ...
		  <ul class="navigation" id="navbar">
            ...
            $result_scat = mysqli_query($conn, $sql_scat);?>             
	           ...
	           $sub_category = strtolower(str_replace(" ", "-", $scat_name)); ?>
				...
				<li class="">
				<a href="https://www.feufo.com/talent"> <span>Find Talent</span> </a>
			</li>    
				<li class="">
				<a href="https://www.feufo.com/book-a-demo.php"> <span>Book A Demo</span> </a>
			</li> 
	  ...
	  <div class="outer-box">
		 <div class="btn-box">
		  ...
		  <a href="https://www.feufo.com/employer-dashboard.php" class="theme-btn btn-style-six">My account</a>
		<?php }else{ ?>
		  <a href="https://www.feufo.com/login.php" class="theme-btn btn-style-six ">Login / Register</a>
	   <?php } ?>
