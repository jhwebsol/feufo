...
$sql_bggs="select * from blog where id='$bid'";
...
<body>
    <div class="page-wrapper">
     ...
     <section class="blog-single">
      ...
      <figure class="main-image"><img src="admin/img/blog/<?php echo $res['banner']; ?>" alt=""></figure>
      <div class="auto-container">
        <h4>Description</h4>
        <p> <?php echo html_entity_decode($res['blod_desp']); ?></p>
        <figure class="image"><img src="img/post-img.jpg" alt=""></figure>
        <h4>Requirements</h4>
