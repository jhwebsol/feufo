...
if (isset($_POST['edit'])) {
 ...
 if(!empty($skill)){
 $skm = implode(',',$skill); }else{
    $skm=$skills; }
 $subject=mysqli_real_escape_string($conn,$_POST['subject']);
 $data = htmlentities( $_POST['data']);
 $id=$_GET['id'];
 $message=mysqli_real_escape_string($conn,$data);
 $sql_qry ="UPDATE jd_detail SET skills='$skm',subject='$subject',message='$message' WHERE id='$id'"; 
                                ...
                                <div class="widget-content">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 mb-4">
                                            <h3 class="text-black">Edit Jd Details</h3>
                                        </div>
                                        <div class="widget-content">
                                          ...
                                          $sqlsr =mysqli_query($conn,"SELECT * FROM employer WHERE id='".$eid."'");
                                             ...
                                             $sqlsrt =mysqli_query($conn,"SELECT * FROM jd_detail WHERE empr_id='".$eid."'");
                                             $resrt= mysqli_fetch_array($sqlsrt);?>
                                            <form class="default-form" action="" method="post">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-lg-12 col-md-12">
                                                        <label>Subject</label>
                                                        <input type="text" name="subject" placeholder="Enter Subject" value="<?= $resrt['subject']; ?>">
                                                        <input type="hidden" name="skills" value="<?= $resrt['skills']; ?>">
                                                    </div>

                                                    <!-- Input -->
                                                    <div class="form-group col-lg-12 col-md-12">
                                                        <label>JD Data</label>
                                                        <textarea name="data" id="summernote" style="height:200px; width:100%; color:#000;"><?= $resrt['message']; ?></textarea>  
                                                    </div>

                                                    <!-- Input -->
                                                    <div class="form-group col-lg-6 col-md-12">
                                                        <button class="theme-btn btn-style-one" type="submit" name="edit">Add</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
