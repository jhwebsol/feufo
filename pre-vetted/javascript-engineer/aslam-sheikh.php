...
$sqler =mysqli_query($conn,"SELECT * FROM employer WHERE id = '".$empr_id."'");
$resr= mysqli_fetch_array($sqler);
//$skid=$resr['skill'];
            ...
            <div class="auto-container">
                ...
                <div class="row">
                    ...
                    <main class="col-lg-8">
                        ...
                        <a href="http://localhost/feufo/book-interview/?id=<?= $ress['id'];?>" class="btn btn-success mb-10">Book Interview </a></div>
                            </div>
                        </article>
                    </main>
                </div>
