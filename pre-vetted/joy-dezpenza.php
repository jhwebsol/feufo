...
while (mysqli_num_rows($viewid) == 0){
$sql="INSERT into posts_views(empr_id,emp_id) values ('$empr_id','$pid')";
$res_prd = mysqli_query($conn, $query);
}  
$empr_id=$_SESSION['employer_id'];
$page_count = (mysqli_query($conn, "SELECT * FROM posts_views where empr_id='".$empr_id."'"));
while (mysqli_num_rows($page_count) <= 5){
}else{
 echo "<script> alert('Please select plan to view this profile!'); 
location.replace('https://www.feufo.com/index.php'); </script>";    
}   
?>
<!DOCTYPE html>
                    ...
                    <main class="col-lg-8">
                        <article class="ps-lg-3">
                            <div class="row">
                             ...
                             <div class="row">
                                <div class="col-lg-12">
						<a href="#" target="_new" class="btn btn-yellow mb-10"> <i class="me-1 fa fa-file"></i> Send JD </a> 
						...
						<a href="#" class="btn btn-warning mb-10">Wishlist </a>
						<a href="https://www.feufo.com/book-appointment.php" class="btn btn-success call-modal signup mb-10">Book Interview </a></div>
                            </div>
                        </article>
                    </main>
                </div>
